        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Comece a usar o AIOS Command Center
            </p>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors disabled:opacity-50"
          >
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Continuar com Google</span>
          </button>
